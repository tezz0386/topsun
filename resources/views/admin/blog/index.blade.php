                        ...
                        <div class="col-md-6">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li>
                                        <a href="{{route('get-status-blog', 'active')}}">
                                            <i class="fa fa-circle text-blue"></i>
                                            Active
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{route('get-status-blog', 'inactive')}}">
                                ...
                                @if (isset($blogs) && count($blogs) > 0)
                                    @foreach ($blogs as $project)
                                        <tr>
                                            ...
                                            <td>{{ $project->title }}</td>
                                            <td>
                                                <a href="{{ asset('uploads/blogs/thumbnail/' . $project->image) }}"
                                                    target="_blank">
                                                    <img src="{{ asset('uploads/blogs/thumbnail/' . $project->image) }}"
                                            ...
                                            @else
                                            <td>
                                                <a href="{{ route('blog.edit', $project) }}">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                            </td>
                                            <td>
