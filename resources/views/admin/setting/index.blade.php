            ...
            <div class="card card-default card-top">
                ...
                <div class="card-body" style="display: block;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" name="contact_no" class="form-control form-control-sm"
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" name="contact_no_2" class="form-control form-control-sm"
                            placeholder="Enter Secondary Contact No" value="{{ old('contact_no_2', @$setting->contact_no_2) }}">
                        @error('contact_no_2')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
            ...
            <div class="card card-default card-top collapsed-card">
                ...
                <div class="card-body" style="display: none;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="google_link" class="form-control form-control-sm"
                            placeholder="Enter Google Link in URL"
                            value="{{ old('google_link', @$setting->google_link) }}">
                        @error('google_link')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
